...
#
# CLI Tools:
# btop tldr neofetch cmatrix speedtest-cli ranger tty-clock lynx cava sysbench vlock mocp
#
...
app_lists[cli]="btop tldr neofetch cmatrix speedtest-cli ranger tty-clock lynx cava sysbench vlock mocp"
